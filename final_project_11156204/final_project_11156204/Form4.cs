...
namespace final_project_11156204
{
    public partial class Form4 : Form
    {
        ...
        private void wally40_Click(object sender, EventArgs e)
        {
            if (x == false)
            {
        ...
        private void wally41_Click(object sender, EventArgs e)
        {
            if (y == false)
            {
                notification.Text = "威力已經被找過囉，\n快去找找其他朋友們吧！";
        ...
        private void Odlaw40_Click(object sender, EventArgs e)
        {
            if (z == false)
            {
