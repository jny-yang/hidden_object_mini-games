...
namespace final_project_11156204
{
    public partial class Form9 : Form
    {
        ...
        private void wally_20_Click(object sender, EventArgs e)
        {
            if (x == false)
            {
        ...
        private void WizardWhitebeard_20_Click(object sender, EventArgs e)
        {
            if (y == false)
            {
                notification.Text = "白鬍子法師已經被找過囉，\n快去找找其他朋友們吧！";
            }
            ...
            if (y == true)
            {
                ...
                current += 2;
                y = false;
                notification.Text = "白鬍子法師已被找到，分數+2\n目前總分：" + (elevator.score).ToString();
                check();
            }
        }

        private void woof_20_Click(object sender, EventArgs e)
        {
            if (z == false)
            {
