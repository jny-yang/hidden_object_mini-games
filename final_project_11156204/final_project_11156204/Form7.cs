...
namespace final_project_11156204
{
    public partial class Form7 : Form
    {
        ...
        private void wally_10_Click(object sender, EventArgs e)
        {
            if (w == false)
            {
        ...
        private void woof_10_Click(object sender, EventArgs e)
        {
            if (x == false)
            {
        ...
        private void wanda_10_Click(object sender, EventArgs e)
        {
            if (y == false)
            {
        ...
        private void Odlaw_10_Click(object sender, EventArgs e)
        {
            if (z == false)
            {
